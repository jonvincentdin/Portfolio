...
// The front end now forces a fresh login (password + emailed code) on every
// page load, so this is really just a fallback ceiling in case that client-
// side logout doesn't run for some reason (e.g. JS disabled). Kept short.
